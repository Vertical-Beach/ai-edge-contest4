...
namespace {
    ...
    constexpr auto DPU_INPUT_IMG_WIDTH    = 704U;
    constexpr auto DPU_INPUT_IMG_HEIGHT   = 352U;
    ...
    constexpr auto DPU_OUTPUT_IMG_WIDTH   = 704U;
    constexpr auto DPU_OUTPUT_IMG_HEIGHT  = 352U;
